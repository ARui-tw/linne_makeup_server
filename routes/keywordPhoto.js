...
keywordPhotoRouter.post('/getKeywordPhoto', authentication(), controller.keywordPhoto.getKeywordPhoto);
keywordPhotoRouter.post('/getKeywordPhotos', authentication(), controller.keywordPhoto.getKeywordPhotos);
